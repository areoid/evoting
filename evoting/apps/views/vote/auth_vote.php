<h2 align="center">Athentication of voting</h2>
<br />
<div class="row">
	<div class="col-md-4">
		<div class="panel panel-primary thumbnail">
			<?php foreach ($_data['votecan']->results() as $res) : ?>
				<img src="<?php echo Redirect::base_url(); ?>assets/admin/imagescandidates/<?php echo $res->path_foto; ?>">
			<?php endforeach;?>
			<div class="panel-body">
				You were choose <b><?php echo $res->name; ?></b> for candidate.
				<input id="id_candidate" type="text" value="<?php echo $res->id_candidate; ?>">
			</div>
		</div>
	</div>
	<div class="col-md-8">
...
<!-- Modal Failed -->
<div class="modal fade" id="modalresvote" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Voting Message</h4>
            </div>
            <div class="modal-body">
                <div class="panel panel-primary">
                    <div class="panel-body">
						Message : <b id="resvote"></b>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" onclick="javascipt:window.location.href='<?php echo Redirect::base_url(); ?>';" >Close</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<?php echo Redirect::base_url(); ?>assets/vote/js/cam.js"></script> 
